...
var DatabaseRequests = /** @class */ (function () {
    ...
    DatabaseRequests.prototype.uploadOne = function (collectionName, data) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.database.collection(collectionName).insertOne(data)];
                    case 1:
                        result = _a.sent();
    ...
    DatabaseRequests.prototype.findOne = function (collectionName, query) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DatabaseRequests.prototype.findMany = function (collectionName, query) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                result = this.database.collection(collectionName).find(query);
...
exports["default"] = DatabaseRequests;
