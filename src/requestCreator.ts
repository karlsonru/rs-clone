...
// создаём запрос к Mongo
function createMongoQuery(clientQuery: Express.Request.query | Express.Request.body): object {
  const mongoRequest: object = {
    $and: [],
  };
